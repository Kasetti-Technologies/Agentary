...
exports.ingestUsageEventHandler = ingestUsageEventHandler;
const usageEventValidator_1 = require("../validators/usageEventValidator");
const eventHasher_1 = require("../utils/eventHasher");
const kafkaProducer_service_1 = require("../services/kafkaProducer.service");
/**
 ...
 */
async function ingestUsageEventHandler(req, res, next) {
    try {
        ...
        (0, usageEventValidator_1.validateUsagePilotEvent)(eventPayload);
        // 3. Compute deterministic event_hash
        const event_hash = (0, eventHasher_1.computeEventHash)(eventPayload);
    ...
    `;
        ...
        const kafkaMeta = await (0, kafkaProducer_service_1.publishUsageEvent)(kafkaMessage);
